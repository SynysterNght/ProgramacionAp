...
<!-- INICIA LA COLUMNA -->
  ...
  <div class="col-md-4">
    ...
    <div class="form-group">
      <label for="idCliente">Id Venta</label>
      <input type="text" name="idVenta" class="form-control" id="idProducto">
    </div>

    <div class="form-group">
        <label for="nombre">Fecha </label>
        <input type="text" name="fecha" class="form-control" id="nombre" >
    </div>

    <div class="form-group">
        <label for="nit">Cliente </label>
        <input type="text" name="cliente" class="form-control" id="stock">
    </div>
